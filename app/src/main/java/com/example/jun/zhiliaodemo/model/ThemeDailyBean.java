...
public class ThemeDailyBean {
    ...
    private List<ThemeStoriesBean> stories;
    /**
    ...
    private List<ThemeEditorsBean> editors;
    ...
    public List<ThemeStoriesBean> getStories() {
        return stories;
    }

    public void setStories(List<ThemeStoriesBean> stories) {
        this.stories = stories;
    }

    public List<ThemeEditorsBean> getEditors() {
        return editors;
    }

    public void setEditors(List<ThemeEditorsBean> editors) {
